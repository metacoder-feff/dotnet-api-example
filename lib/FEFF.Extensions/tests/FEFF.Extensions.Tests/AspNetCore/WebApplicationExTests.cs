...
namespace FEFF.Extensions.Tests.AspNetCore;
...
{
    protected EnvironmentFixture EnvFx { get; } = TestContext.Current.GetFeffFixture<EnvironmentFixture>();
    ...
    public void DisableReloadConfigByDefault(string? initialEnvValue, bool actionIsApplied, bool expected)
    {
        ...
        EnvFx.SetEnvironmentVariable("DOTNET_HOSTBUILDER__RELOADCONFIGONCHANGE", initialEnvValue);
