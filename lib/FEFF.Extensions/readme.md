...
| FEFF.Extensions.SemaphoreLock | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |

* (*1) The aim of 'FEFF.Extensions.SemaphoreLock' is to avoid concurrent access to a resource. There is no matter to throw 'ObjectDisposedExeception' at Release() because Lock would never be entered again when it is disposed.
